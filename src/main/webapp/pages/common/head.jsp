...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/camera.css" />">
    <link rel="stylesheet" href="<c:url value="/css/owl-carousel.css" />">
    <script src="<c:url value="/js/jquery.js" />"></script>
    <script src="<c:url value="/js/jquery-migrate-1.2.1.js" />"></script>
    <!--[if lt IE 9]>
        <html class="lt-ie9">
    ...
    <![endif]-->
    <script src="<c:url value="/js/device.min.js" />"></script>
</head>
